 ...
 $('.big-button').after("#shadow:active");
    ...
    img1.on('click', function () {
        ...
        copy.animate({
            ...
            info.append("<button id=dugme1 class=big-button data-action=submit>Push the button</button>");
    ...
    img2.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info2);
             info.append("<button id=dugme2 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img3.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info3);
             info.append("<button id=dugme3 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img4.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info4);
             info.append("<button id=dugme4 class=big-button data-action=submit>Push the button</button>");
        });
  ...
  '_blank' // <- This is what makes it open in a new window.
    ...
    img5.on('click', function () {
        ...
        copy.animate({
            ...
            info.append("<button id=dugme5 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img6.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info6);
             info.append("<button id=dugme6 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img7.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info7);
             info.append("<button id=dugme7 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img8.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info8);
             info.append("<button id=dugme8 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img9.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info9);
             info.append("<button id=dugme9 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img10.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info10);
             info.append("<button id=dugme10 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img11.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info11);
             info.append("<button id=dugme11 class=big-button data-action=submit>Push the button</button>");
        });
    ...
    img12.on('click', function () {
        ...
        copy.animate({
            ...
            info.append(img1info12);
             info.append("<button id=dugme12 class=big-button data-action=submit>Push the button</button>");
        });
